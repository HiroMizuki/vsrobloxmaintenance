...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Roblox Maintenance Mod Team'],
		['NaferNightmare',      'NaferNightmare',   'Mod Director, Animator and Composer',              'https://twitter.com/NaferNightmare',   0xFFFFCA55], 
		['Suok',		        'Suok',		        'Animator, Artist and Coder',					    'https://twitter.com/oSuOk3',	        0xFFFF3885],
		['Senshi_Z',            'Senshi_Z',         'Charter',                                          'https://twitter.com/Senshi_Z12',       0xFF83FF76],     
		['Hiro Mizuki',         'Hiro',             'Coder',                                            'https://www.youtube.com/channel/UCocLUzcPyeHkI6QG3A78F-w',       0xFF84F5A6],     
		[''],
		['Psych Engine Team'],
